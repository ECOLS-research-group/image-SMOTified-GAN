...
SAMPLE_LEN = 32
BATCH = 2      # number N of points where a curve is sampled
SAMPLE_SIZE = 16384   # number of curves in the training set
...
for e in range(EPOCHS):
    for k in range(SAMPLE_SIZE//BATCH):
        ...
        n = np.random.randint(0, SAMPLE_SIZE - 1, BATCH)
    ...
    print(
        f" {e:04n} |  {d_result[0]:.5f}  |  {d_result[1]:.5f} |  {g_result[0]:.5f}  |  {d_result[1]:.5f}")
